...
export default function Auth() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Don't set submitting to false on success - redirect will happen
  };
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative">
        <img
          src={authHeroImage}
          alt="Premium LanCon home exterior"
        ...
        <div className="relative z-10 flex flex-col justify-end p-12 text-white">
          <div className="max-w-lg">
            ...
            <p className="text-lg text-white/90 leading-relaxed">
              Building premium family homes in Brisbane since 2008. 
              Your house provides shelter, but your home is the launch pad for life's greatest memories.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Auth Form Section */}
      <div className="flex-1 flex items-center justify-center bg-background px-4 py-12 lg:px-8">
        <div className="w-full max-w-md animate-scale-in">
          ...
          <div className="flex flex-col items-center gap-3 mb-8">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-serif font-bold text-foreground tracking-tight">LanCon Qld</h1>
              <p className="text-sm text-muted-foreground font-medium">Metrics Dashboard</p>
            </div>
          </div>
          ...
          <Card className="glass-card-elevated border-border/50">
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                variant="outline"
                className="w-full h-12 gap-3 bg-card/50 border-border/50 hover:bg-muted/50 font-medium"
              ...
              <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'signin' | 'signup')}>
                ...
                <TabsContent value="signup" className="mt-6">
                  <form onSubmit={handleSignUp} className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="signup-name" className="font-medium">Display Name</Label>
                      <div className="relative">
